...
namespace TTBS.Services
{
    ...
    public class StenografService : BaseService, IStenografService
    {
        ...
        {
            return _stenoGorevRepo.Get(x => (int)x.Stenograf.StenoGorevTuru == gorevTuru && x.GorevStatu != GorevStatu.YerDegistirme, includeProperties: "Stenograf.StenoIzins,Birlesim");
        }
